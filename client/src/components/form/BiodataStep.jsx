...
export default function BiodataStep({ data, onChange, errors, onSectionChange }) {
            ...
            {current.id === 'rotaract' && (
              <>
                <div>
                  ...
                  <input type="text" value={data.clubName} onChange={update('clubName')} placeholder="Rotaract Club of..." className={fc('clubName')} />
